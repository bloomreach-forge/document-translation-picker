package org.onehippo.forge.documenttranslationpicker.beans;
/*
...
public class ContentDocument extends BaseDocument {
    ...
    public String getIntroduction() {
        return getProperty("documenttranslationpickerdemo:introduction");
    }

    @HippoEssentialsGenerated(internalName = "documenttranslationpickerdemo:title")
    public String getTitle() {
        return getProperty("documenttranslationpickerdemo:title");
    }
    ...
    public Calendar getPublicationDate() {
        return getProperty("documenttranslationpickerdemo:publicationdate");
    }
}
